# Auratune - Pipeline de Geração Musical

Este README descreve o fluxo de geração de música no diretório `src` do projeto Auratune.
...
**Importante:** Execute sempre a partir do diretório raiz do projeto (`auratune/`) para que os imports Python funcionem corretamente.
