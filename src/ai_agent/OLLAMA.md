...
Sua tarefa é refatorar os script Python já existente e funcional no diretório C:\devtools\repo\auralith\src\scripts que utiliza modelos da Hugging Face para gerar músicas. O objetivo é melhorar o desempenho e organizar o processo em um pipeline estruturado, sem quebrar a funcionalidade atual.
